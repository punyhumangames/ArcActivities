...
public:
	...
	virtual TSharedRef<FActivityEditor> CreateActivityEditor(const EToolkitMode::Type Mode, const TSharedPtr< class IToolkitHost >& InitToolkitHost, class UActivity* Object);
