...
void FArcGraphNodeClassHelper::BuildClassGraph()
{
	...
	Filter.ClassPaths.Add(UActivityServiceBlueprint::StaticClass()->GetClassPathName());
	Filter.ClassPaths.Add(UObjectiveTrackerBlueprint::StaticClass()->GetClassPathName());
