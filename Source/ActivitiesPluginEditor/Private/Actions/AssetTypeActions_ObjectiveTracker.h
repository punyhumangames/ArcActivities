...
public:
	...
	UPROPERTY(EditAnywhere, Category = Factory)
		TSubclassOf<class UActivityTask_ObjectiveTracker> ParentClass;
...
public:
	...
	virtual UClass* GetSupportedClass() const override { return UObjectiveTrackerBlueprint::StaticClass(); }
