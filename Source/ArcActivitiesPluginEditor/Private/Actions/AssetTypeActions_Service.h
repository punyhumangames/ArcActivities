...
public:
	...
	UPROPERTY(EditAnywhere, Category = Factory)
		TSubclassOf<class UArcActivityTask_StageService> ParentClass;
...
public:
	...
	virtual UClass* GetSupportedClass() const override { return UArcActivityTask_StageServiceBlueprint::StaticClass(); }
